...
============
- Execute the, `rtc_rest::threads::startThreadInForumChannelAsync()` function, while passing in a value of type `rtc_rest::start_thread_in_forum_channel_data`, with a return value of type `auto` or `rtc_rest::thread`.
