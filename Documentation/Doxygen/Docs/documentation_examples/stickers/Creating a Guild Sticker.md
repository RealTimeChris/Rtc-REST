...
============
- Execute the, `rtc_rest::stickers::createGuildStickerAsync()` function, while passing in a value of type `rtc_rest::create_guild_sticker_data`, with a return value of type `auto` or `rtc_rest::sticker`.
