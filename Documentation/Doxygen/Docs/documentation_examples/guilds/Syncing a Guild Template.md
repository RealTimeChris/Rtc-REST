...
============
- Execute the, `rtc_rest::guilds::syncGuildTemplateAsync()` function, while passing in a value of type `rtc_rest::sync_guild_template_data`, with a return value of type `auto` or `rtc_rest::guild_template_data`.
