...
============
- Execute the, `rtc_rest::reactions::getReactionsAsync()` function, while passing in a data structure of type `rtc_rest::get_reactions_data`, with a return value of type `auto` or `std::vector<user>`.
