...
============
- Execute the, `rtc_rest::messages::deleteMessagesBulkAsync()` function, while passing in a data structure of type `rtc_rest::delete_messages_bulk_data`, with a return value of type `void`.
